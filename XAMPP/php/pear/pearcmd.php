...
if ('C:\Users\janne.sillanpaa\Documents\XAMPP\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\janne.sillanpaa\Documents\XAMPP\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
